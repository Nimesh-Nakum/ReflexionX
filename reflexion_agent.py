  ...
  "confidence": 0-100
        ...
        for i in range(self.max_iterations):
            context = {
                ...
                "poc_unconfirmed": os.listdir(os.path.join(self.output_dir, "poc", "unconfirmed")) if os.path.exists(os.path.join(self.output_dir, "poc", "unconfirmed")) else []
            }
    ...
    def write_pentest_report(self):
        ...
        stats = {
            "target": self.target,
            "confirmed_xss": len(self.state["confirmed_findings"]),
