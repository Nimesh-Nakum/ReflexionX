...
Usage: $0 -d <domain> [options]
  ...
  -A  Enable auto form extraction and POST stored XSS testing
...
main() {
  ...
  if checkpoint_check browser_validation; then
    ...
    local combined_browser_input="$OUT/tmp/browser_targets_combined.txt"
    {
